...
private:
    ...
    static clsCurrency _ConvertLinetoCurrencyObject(string Line, string Seperator = "#//#")
    {
        ...
        vCurrencyData = clsString::Spilt(Line, Seperator);
...
public:
    ...
    static   clsCurrency FindByCode(string CurrencyCode)
    {
        ...
        CurrencyCode = clsString::ChangeLettersCase(CurrencyCode, true);
    ...
    {
        Country = clsString::ChangeLettersCase(Country, true);
        ...
        if (MyFile.is_open())
        {
            ...
            {
                clsCurrency Currency = _ConvertLinetoCurrencyObject(Line);
                if (clsString::ChangeLettersCase(Currency.Country(), true) == Country)
                {
                    MyFile.close();
                    return Currency;
                }
